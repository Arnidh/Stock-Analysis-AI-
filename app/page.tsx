...
export default function Home() {
  return (
    <main className="Flex min-h-screen flex-col items-center p-24 font-poppins">
      <Hero/>

      <div className="mt-32">
        <p className="text-xl md:text-2xl text-center leading-loose">
          Welcome to the next generation of stock market analysis. Our AI-powered
          application harnesses the power of advanced machine learning algorithms to
          analyze historical stock data and provide accurate predictions, helping you
      ...
      <section id="why-choose-us" className="my-32">
        <h2
          className="text-2xl font-semibold mb-5 text-center border-b border-b-yellow-400"
        >
          Why Choose This AI Chatbot?
        </h2>

        <ul className="text-xl md:text-xl ">
      ...
      <section id="how-it-works" className="my-32">
        <h2
          className="text-2xl font-semibold mb-5 text-center border-b border-b-yellow-300"
        >
          How It Works
        </h2>
      ...
      <section id="who-can-benefit" className="my-32">
        ...
        <ul className="text-xl md:text-xl">
          <li className="list-disc leading-loose">
            Individual Investors: Whether you&apos;re new to investing or looking to
            optimize your strategy, our chatbot offers insights to help grow your
            portfolio.
          </li>
          <li className="list-disc leading-loose">
      ...
      <div className="mt-32 text-center">
        ...
        <p className=" text-xl md:text-xl text-center leading-loose">
          ...
          complexities of the stock market. Start chatting now and take control of
