    ...
    <main className="h-full p-20">
      ...
      >
        ...
        <small className="text-sm font-medium mb-5">
          ...
          <i className="text-red-300">The max you can add is five.</i>
        </small>
        ...
        <Button
          className="bg-yellow-600 my-2 font-medium disabled:bg-transparent"
        ...
        <Button className="bg-orange-600 my-2 font-medium disabled:bg-transparent">
